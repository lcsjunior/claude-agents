...
<critical>Pasta existir ≠ fluxo concluído. Só encerre quando `codereview.md` estiver APROVADO. Status REPROVADO obriga nova rodada de implementação.</critical>
...
| `codereview.md` APROVADO | Encerrado; pergunte ao usuário se quer nova iteração |
